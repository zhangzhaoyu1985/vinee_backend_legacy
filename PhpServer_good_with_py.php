...
$loader->registerDefinition('wineMateLogin', $GEN_DIR);
$loader->register();
...
class WineMateLoginHandler implements \wineMateLogin\WineMateUserLoginIf {

  public function login(\wineMateLogin\User $user) {
    //return \wineMateLogin\LoginStatus::LOGIN_SUCCESS;
	return \wineMateLogin\LoginStatus::LOGIN_SUCCESS;
  }
 
  public function registration(\wineMateLogin\User $user) {
    return \wineMateLogin\RegistrationStatus::REGISTRATION_SUCCESS;
  }

  public function findPassword(\wineMateLogin\User $user) {
    return \wineMateLogin\FindPasswordStatus::PW_SUCCESS;
  }
};
...
$handler = new WineMateLoginHandler();
$processor = new \wineMateLogin\WineMateUserLoginProcessor($handler);
